...
public class CGController {
	...
	@RequestMapping(value = "${cg.controller.root.request.mapping.value}",method = { RequestMethod.GET, RequestMethod.POST })
	...
	public ModelAndView  processCgCallback(HttpServletRequest request,HttpServletResponse response,@RequestBody String requestBody,Model model, @PathVariable("id") long id) {
		...
		try {
			...
			// Based on id value  you impl product specific code here
